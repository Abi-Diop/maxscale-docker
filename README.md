...
-	Abi Diop:  
	(https://github.com/Abi-Diop/maxscale-docker/tree/master/maxscale)
...
```
abi@Ubuntu:~/CNE370/maxscale-docker/maxscale$ sudo docker-compose exec maxscale maxctrl list servers
...
abi@Ubuntu:~/CNE370/maxscale-docker/maxscale$ nano main.py 
Then run the code wit the command:
abi@Ubuntu:~/CNE370/maxscale-docker/maxscale$ python3 main.py
